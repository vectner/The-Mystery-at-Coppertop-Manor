(() => {
  const adventureName = 'The Mystery at Coppertop Manor';
  const moduleName = 'pla01-tmacm';
   ...
   */
  const welcomeJournal = 'Table of Contents';
  /**
   ...
   */
  const additionalModulePacks = ["pla01-tmacm","dnd5e"];
